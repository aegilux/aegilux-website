...
const painPoints = [
  "SoA drafting drag — 30–60 pages, 4–8 hours senior time at A$200–400/hr plus paraplanner cycles. A 100-staff licensee writing 50–150 SoAs/month carries A$1.5–3M internal cost annually.",
  "File-note compliance gap — RG 175 BID and Corporations Act §286 demand notes that survive a 7-year ASIC review. Junior advisers under-document; AFCA disputes turn on the cleaner file.",
  "AI sprawl the principal can't govern — Copilot, ChatGPT, and Padua's AI module running across the licensee with zero privacy-register entries and zero APP 1.7–1.9 disclosure draft.",
];

const whatWeShip = [
  "AI Chief of Staff — master orchestrator, persistent memory, Telegram / Slack / email / Vapi voice",
  "SoA Drafter sub-agent — pulls fact-find from Xplan or AdviserLogic, drafts against Padua or Midwinter, posts draft for AFSL-licensed adviser to review and sign",
  "File-Note Compliance sub-agent — RG 175 BID-compliant notes, §286 audit trail",
  ...
  "Monthly automated compliance report — PDF + JSON to compliance officer and underwriter",
];
...
const hitlSteps = [
  {
    step: "01",
    title: "Agent drafts",
    desc: "SoA Drafter pulls fact-find from Xplan or AdviserLogic, drafts the Statement of Advice against Padua or Midwinter's engine. Typically under 2 hours.",
  },
  {
    step: "02",
    title: "AFSL-licensed adviser reviews",
    desc: "Draft posted to Telegram or Slack with a sign-off prompt. Adviser reviews, edits, and applies the approval gesture. Named reviewer, timestamp, raw draft, edits, and signed-off output all captured.",
  },
  {
    step: "03",
    title: "7-year immutable audit trail",
    desc: "Every prompt, tool call, output, and metadata retained on AWS S3 Object Lock Compliance mode for 7 years — independent of Anthropic's 30-day default. Corporations Act §286 answer.",
  },
];
...
const pricingTiers = [
  {
    ...
    price: "A$25,000",
    timeline: "30 days",
    desc: "Chief of Staff + 1 vertical sub-agent. PIA-light. Owner-decisive sub-100 staff.",
    highlighted: false,
  },
  {
    ...
    price: "A$35,000",
    timeline: "45–60 days",
    desc: "Chief of Staff + SoA Drafter + 1 cross-vertical sub-agent + full PIA + APP + ML2 gap. Default for 100-staff AFSL houses.",
    highlighted: true,
    badge: "Default quote",
  },
  {
    ...
    price: "A$55,000",
    timeline: "60–90 days",
    desc: "Chief of Staff + 2 vertical sub-agents + 1–2 cross-vertical sub-agents + customer-held KMS + named-attribution rights. 150–200 staff multi-practice.",
    highlighted: false,
  },
];
        ...
        <div className="section-container max-w-5xl">
          ...
          >
            ...
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-5">
              AI Chief of Staff for Financial Advice,{" "}
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-3xl mb-8">
              Privacy-Act-by-design. Essential-Eight-aligned. The agent and
              the compliance pack ship inside one Phase 1 engagement — so
              the position holds at the next ASIC review, AFCA dispute,
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-8 max-w-2xl">
              82% of AU advisers now use AI — the highest adoption rate
              globally. 39% have a written AI policy. The 47-point gap between
              adoption and governance is where regulatory risk lives.
            </p>
            ...
            <div className="mt-8 grid sm:grid-cols-3 gap-4">
              {[
                { label: "APP 1.7–1.9", desc: "Takes force 10 December 2026. PIA + ADM register mandatory." },
                { label: "ASIC RG 255", desc: "Suitably qualified individual reviews every AI output. AFSL holder carries the obligation personally." },
                { label: "Corp Act §286", desc: "7-year audit trail mandatory. Anthropic default: 30 days. Aegilux: 7 years on S3 Object Lock." },
              ].map((item, i) => (
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-8 max-w-2xl">
              ASIC RG 255 requires a suitably qualified individual to review
              and sign every AI-generated SoA. That is the design spec, not
              a constraint. The agent drafts. The licensed adviser signs.
            </p>
          ...
          >
            ...
            <div className="glass p-5 cyber-corners">
              <p className="font-mono-cyber text-xs text-muted-foreground leading-relaxed">
                ...
                automated compliance report shipped to compliance officer and
          ...
          >
            <h2 className="font-heading text-xl font-bold mb-3">
              Where does your licensee sit against the December 2026 deadline?
            </h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-lg mx-auto">
              20-minute call. No pitch — compare notes on your AI adoption,
              your sign-off chain, and your security questionnaire readiness.
            </p>
