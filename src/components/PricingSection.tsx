...
const plans = [
  {
    ...
    price: "$3,500",
    suffix: "/mo",
    note: "≤3 AWS accounts ($4,500 for 4–5 accounts)",
    highlighted: false,
    features: [
  ...
  },
  {
    ...
    price: "$6,000",
    suffix: "/mo",
    note: "≤100 endpoints ($8,000 for 101–200 endpoints)",
    highlighted: true,
    badge: "Most Popular",
    features: [
  ...
  },
  {
    ...
    price: "$10,000",
    suffix: "/mo",
    note: "≤100 endpoints ($14,000 for 101–200 endpoints)",
    highlighted: false,
    features: [
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Start with a $2,500 E8 Posture Snapshot — credited against Landing
            Zone Lite if you proceed. Then pick a managed tier. No usage-based
            billing, no minimum-volume traps.
          </p>
        </motion.div>
        ...
        >
          Plus one-time onboarding ($3K–$8K, scales with environment) and
          Landing Zone Lite ($12K small / $22K medium). &gt;200 endpoints or
          &gt;5 AWS accounts — custom quote.
        </motion.p>
      </div>
    </section>
  );
