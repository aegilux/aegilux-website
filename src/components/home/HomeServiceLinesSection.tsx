...
const lines = [
  ...
  },
  {
    ...
    accent: "Compliance baked in.",
    desc: "AI Chief of Staff for AU regulated SMBs. Privacy Act PIA, APP 1.7–1.9 disclosure pack, and Essential Eight ML2 gap report shipped inside Phase 1 — before the 10 December 2026 ADM deadline.",
    bullets: [
      "Phase 1 build (30–90 days) + mandatory Phase 2 retainer",
      "Financial advice · allied health · law · gov-supply · fintech",
      "Privacy-Act-by-design, AU residency on AWS Sydney",
    ],
